...
class SaleHouse(models.Model):
    ...
    addr_building = models.IntegerField(default=0)
    addr_unit = models.IntegerField(default=0)
    addr_room = models.IntegerField(default=0)
...
class RoomInfo(models.Model):
    ...
    mianji = models.IntegerField(default=0, null=True)
    addr_xiaoqu = models.CharField(max_length=30)
    addr_building = models.IntegerField(default=0)
    addr_unit = models.IntegerField(default=0)
    addr_floor = models.IntegerField(default=0)
    addr_room = models.IntegerField(default=0)
